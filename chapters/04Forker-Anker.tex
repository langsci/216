...
Since our data stems from written corpora, it is not possible to determine any \isi{prosodic} differences between the reference clause and the bridging clause and therefore the \isi{prosodic} properties of \ili{Tsezic} bridging constructions must be left for future research.
...
Beside the perfective \isi{converb}, we find the anterior \isi{converb} \refex{ex:7ab}, \refex{ex:8ab}, \refex{ex:12ab}, the immediate anterior \isi{converb} \refex{ex:3ab} and the simultaneous \isi{converb} \refex{ex:9ab} in bridging clauses. 
...
\textsc{cond}		conditional \isi{converb},
\textsc{cont}		contact case,
\textsc{cvb}		perfective/\isi{narrative} \isi{converb},
\textsc{dat}		dative,
...
\textsc{imm.ant}	immediate anterior \isi{converb},
...
\textsc{icvb}		imperfective \isi{converb},
...
\textsc{purp.cvb}	purposive \isi{converb},
\textsc{quot}		quotative,
\textsc{red}		\isi{reduplication},
\textsc{res}		resultative,
\textsc{sg}		singular,
\textsc{sim.cvb}	simultaneous \isi{converb},
\textsc{spr}		super case, 
\textsc{sub}		sub case,
\textsc{temp}		temporal \isi{converb},
