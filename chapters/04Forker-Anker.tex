...
Besides the perfective \isi{converb}, we find the anterior \isi{converb} (as in \refex{ex:7ab}, \refex{ex:8ab}, and \refex{ex:12ab}), the immediate anterior \isi{converb} in \refex{ex:3ab} and the simultaneous \isi{converb} in \refex{ex:9ab} in bridging clauses. 
