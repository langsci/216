...
Valérie Guérin analyzes \isi{recapitulative linkage} in \ili{Mavea}, an \ili{Oceanic} language of Vanuatu. In Chapter 8, she shows that bridging clauses are morphologically main clauses but phonologically marked as dependent and that their function in discourse is mostly to add emphasis. 
