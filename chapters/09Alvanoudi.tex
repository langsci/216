...
\TLine[{FS >}{>}]{Th}{%
  \gll \hspace{1em} \textbf{{[}°Εsí}            \textbf{ti}                    \textbf{{[}ɣ\underline{nó}{]}ri{]}ses} aftín.\\ 
  {} \textsc{2sg.nom} \textsc{3sg.f.acc}   meet.\textsc{2sg.pst}   \textsc{3sg.f.acc}\\
 \glt  \hspace{1em} `You met her.'}\\
\TLine{Tel}{% 
		 \hspace{2.15in}{[}°(Νe,){]}
...
\item Double parentheses are used to mark meta-linguistic, para-linguistic and non-conversational descriptions of events by the transcriber. For example: ((laughs))
