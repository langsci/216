...
Every line given in (\ref{Aiex:06af}) is a \isi{clause chain}, and each of the main clauses (\ref{Aiex:06c} to \ref{Aiex:06f}) begin with a non-main medial
